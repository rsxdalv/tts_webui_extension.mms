...
def generate_audio_with_mms(
    ...
    **kwargs,
    ...
    return tts(text, language, speaking_rate, noise_scale, noise_scale_duration, **kwargs)
...
def get_mms_languages():
    ...
    try:
        ...
        languages_file = os.path.join(os.path.dirname(__file__), "resources", "mms-languages-iso639-3.txt")
...
def extension__tts_generation_webui():
    ...
    return {
        ...
        "extension_website": "https://github.com/rsxdalv/extension_mms",
